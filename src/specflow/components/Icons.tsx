...
export function HandIcon({ size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ConductorIcon({ size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LLMIcon({ size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MuteIcon({ size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
